...
import telos.lib.network.messages.unit.*;
 ...
 */
@Serializable
public class CreateStructureMessage extends AbstractMessage {
    private String _id;
    ...
    public CreateStructureMessage() { }
    public CreateStructureMessage(String id, Vector3f loc, String name, int hp) {
        _id = id;
        _loc = loc;
        _name = name;
        _hp = hp;
    ...
    public CreateStructureMessage(Structure u) {
        _id = u.getId();
        _dbId = u.getDbId();
        _loc = u.getLoc();
        _hp = u.getHp();
